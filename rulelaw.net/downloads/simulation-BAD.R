# Actual code used to generate simulation in book chapter 9.
...
# total 100k+ rounds.
# to initiate: add "simulate.ch9(NUMBER OF RUNS)" to bottom of file then run in batch.
# I ran with something like 25 parallel instances of 4k runs each, took under a week.
...
# quickie function to get all the CSVs back (DOES NOT WORK, ended up concatenating by hand)
